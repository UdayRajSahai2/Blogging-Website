...
const Notification = () => {
  ...
  // Add refresh function specifically for after replies
  const refreshNotifications = async () => {
    
    // Simple approach: just refetch the first page like we do on filter change
    if (access_token) {
  ...
  const capitalizeFilter = (filterName) => {
