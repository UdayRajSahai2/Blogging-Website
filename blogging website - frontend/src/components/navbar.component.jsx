        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-3 items-center py-4 sm:py-3">
            ...
            <div className="flex justify-center">
              <span className="text-[18px] sm:text-lg font-semibold text-cyan-700 text-center">
              ...
              {!access_token ? (
                ...
                <>
                  ...
                  <Link to="/dashboard/notifications" className="relative">
                    <button className="w-10 h-10 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors flex items-center justify-center relative">
