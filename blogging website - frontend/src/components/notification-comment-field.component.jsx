  ...
  const handleReply = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (refreshNotifications && typeof refreshNotifications === 'function') {
        ...
        <div className="space-y-4">
          ...
          {userAuth.profile_img && (
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-dark-grey">
                Replying as <span className="font-medium text-black">{userAuth.fullname}</span>
              </span>
            </div>
          )}
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-2 right-2 text-xs text-dark-grey bg-white px-2 py-1 rounded">
              <span className={reply.length > 900 ? 'text-red font-medium' : ''}>
                {reply.length}/1000
              </span>
            </div>
          </div>
