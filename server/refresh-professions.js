import { clearProfessionData, importProfessionData, getProfessionStats } from './utils/import-profession-data.js';
...
const refreshProfessionData = async () => {
  try {
    ...
    console.log(`📈 Data change: ${beforeStats.total} → ${afterStats.total} records`);
    console.log(`📊 Breakdown: ${afterStats.domains} domains, ${afterStats.fields} fields, ${afterStats.specialties} specialties`);
